...
** Path
#+begin_src conf
PATH=$HOME/bin:$HOME/.local/bin:$HOME/.yarn/bin:$HOME/.pyenv/bin:$HOME/.poetry/bin:$HOME/.emacses/doom/emacs.d/bin:$PATH
export PATH
#+end_src
...
NVM_DIR="$HOME/.nvm"
lazyload nvm node gatsby yarn npm npx -- 'source "$NVM_DIR/nvm.sh"'
#+end_src
